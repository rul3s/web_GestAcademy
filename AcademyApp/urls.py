...
urlpatterns = [
    ...
    url(r'^academies/post$', views.add_acdmy, name='addAcademy'),
    url(r'^academies/update/(?P<academy_id>[0-9]+)', views.edit_acdmy, name='editAcademy'),
    url(r'^academies/delete/(?P<academy_id>[0-9]+)', views.rem_acdmy, name='remAcademy'),
